...
jQuery(document).ready(function ( $ ){
    ...
    if ($(".cb-parallax-background-image-url").attr("src")){
        ...
        if (AdminMeta.parallax_possible){
            ...
            $('input#cb-parallax-enabled-checkbox').show();
            $('label[for="cb-parallax-enabled-checkbox"]').show();
        }
    } else{

        $(".cb-parallax-background-image-url").hide();
        $('input#cb-parallax-enabled-checkbox').hide();
        $('label[for="cb-parallax-enabled-checkbox"]').hide();
    }
